...
class RegisterController extends Master
{
    /*
    |--------------------------------------------------------------------------
    | Register Controller
    ...
    */
    ...
    {   $len =  strlen($data['mobile']);
        ...
        return User::create([
            'name' => ucwords(strtolower($data['first_name'])).' '.ucwords(strtolower($data['last_name'])),
    ...
    public function thankyou(Request $request) {
        ...
        return view(Master::loadFrontTheme('firezyshop.Register.thankyou'),array('pincode'=>$pincode));
    }
    ...
    public function registerPage(Request $request) {
        $pincode = $this->getPinCode();
        return view(Master::loadFrontTheme('firezyshop.Register.index'),array('pincode'=>$pincode));
    }
