...
<head>
  ...
  <title>Reset Your Go4shop Password</title>
  <!--[if !mso]>
      <!-- -->
...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 text-align: left; text-align: left; font-size: 14px; '>At Go4shop.online, our endeavour is to make the most of the time that you take out for your shopping experice. We care for the unique perspective, the appreciation of excellence and that which maybe simple but not ordinary. Here you can Shop More ~ Earn More, For More Details, Please visit our website www.go4shop.online.
                              </p>
 ...
 Helvetica, sans-serif; font-size: 12px;" valign="top">
                                <div style="text-align: center;">
                                  ...
                                  © Copyright 2020 Go4Shop.online, All rights reserved, Powered by Go4Shop.Online.</div>
                              </td>
                            </tr>
                            <tbody></tbody>
                          </tbody>
 ...
 100%; -webkit-text-size-adjust: 100%; ">
                          <tbody>
                            <tr>
                              ...
                              <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 -webkit-text-size-adjust: 100%">
                                <a href="https://www.instagram.com/go4shop/" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 ...
 text-decoration: none" width="32" />
                              ...
                              <td style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 -webkit-text-size-adjust: 100%">
                                <a href="https://www.facebook.com/go4shoponline" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
