...
#wrapper .dd-header.select {
  border-left: 10px solid #9cbe4f;
  background-color: #000;
}
#wrapper .dd-header.select .icon-beaker,
#wrapper .dd-header.select .icon-bar-chart {
  color: #9cbe4f;
  text-shadow: 0px 0px 1px #fff004;
  font-size: 50px;
}
#wrapper .dd-header.select .dd-main {
  color: #9cbe4f;
  font-size: 14px;
}
#wrapper .dd-header.select .dd-sub {
  color: #ccc;
  font-size: 24px;
}
...
#wrapper .dd-header .hidden {
  display: none;
  list-style-type: none;
  background-color: #fff;
  border: 1px solid #fff;
}
#wrapper .dd-header .hidden p {
  margin: 14px 0 14px -24px;
  padding: 0;
  width: 100%;
  background-color: #fff;
}
#wrapper .dd-header div {
  height: 100px;
  position: relative;
}
.icon-beaker,
...
<?php if(!empty($sellerArr)){ 
	//dd($sellerArr);
	  // if($sellerArr)
	$shopInformation = false;
	$shopInformationImg = 'no.jpg';
	if($sellerArr->business_name!='' && 
		$sellerArr->image_thumb!=''  && 
		$sellerArr->image_logo!=''   && 
		$sellerArr->businessusername!='' &&
		$sellerArr->pincode!=''){

		$shopInformation = true;
		$shopInformationImg = 'ok1.png';
	}

	$contactDetails = false;
	$contactDetailsImg = 'no.jpg';
	if($sellerArr->contact_number!=''){
		$contactDetails = true;
		$contactDetailsImg = 'ok1.png';
	}

	$keyctDetails = false;
	$keyctDetailsImg = 'no.jpg';
	if($sellerArr->account_holder_name!=''){
		$keyctDetails = true;
		$keyctDetailsImg = 'ok1.png';
	}

	$productsDetails = false;
	$productsDetailsImg = 'no.jpg';
	if($sellerProductsCount>0){
		$productsDetails = true;
		$productsDetailsImg = 'ok1.png';
	}


	$verifytDetails = false;
	$verifyDetailsImg = 'no.jpg';
	if($sellerArr->account_holder_name!=''){
		$verifytDetails = true;
		$verifytDetailsImg = 'ok1.png';
	}	


	$live = false;
	$liveImg = 'no.jpg';
	if($sellerArr->status==1){
		$live = true;
		$liveImg = 'ok1.png';
	}
}?>
						...
						<div class="col-md-2 widget widget1">
							...
							<div class="r3_counter_box">
								...
								<div class="stats">
								  ...
								  <div class="grow" style="color: green">
									<p>Delivered</p>
								  </div>
								</div>
							</div>
						 ...
						 <div class="col-md-3 widget">
							<div class="r3_counter_box">
								<i class="fa fa-inr"></i>
								<div class="stats">
								  <h5>₹{{($totalAmount!='')?number_format($totalAmount,2):0.00}}</h5>
...
<div id="wrapper">
	...
	<div class="col-md-12">
		<div class="alert alert-warning" >Your Shop will not published until you will not updated these details. Kindly update all the details first.
		</div>
		</div>
	</div>
    ...
    <ul class="dd-header">
        <li>
            <div>
                <a href ="{{url('seller')}}">
                  <i class="icon-beaker"><img src="{{config('global.THEME_URL_IMAGE').'/images/'.$shopInformationImg}}" style="width: 44px"></i>
                  <div class="dd-content">
                    <H2 class="dd-main">Shop Information</H2>
                    <H3 class="dd-sub">Personalized To Your Shop Details</H3> 
                  </div>
                </a>
            </div>
        </li>
    ...
    <ul class="dd-header">
        <li>
            <div>
                <a href ="{{url('seller')}}">
                  <i class="icon-bar-chart"><img src="{{config('global.THEME_URL_IMAGE').'/images/'.$contactDetailsImg}}" style="width: 44px"></i>
                  <div class="dd-content">
                    <H2 class="dd-main">Contact Details</H2>
                    <H3 class="dd-sub">Update Your Valid Contact Information</H3> 
                  </div>
                </a>
            </div>
        </li>
...
<div class="col-md-4">
    <ul class="dd-header">
        <li>
            <div>
                <a href ="#">
                  <i class="icon-beaker"><img src="{{config('global.THEME_URL_IMAGE').'/images/'.$keyctDetailsImg}}" style="width: 44px"></i>
                  <div class="dd-content">
                    <H2 class="dd-main">KYC Details</H2>
                    <H3 class="dd-sub">Update KYC With Valid Details</H3> 
                  </div>
                </a>
            </div>
    ...
    <ul class="dd-header">
        <li>
            <div>
                <a href ="#">
                  <i class="icon-bar-chart"><img src="{{config('global.THEME_URL_IMAGE').'/images/'.$productsDetailsImg}}" style="width: 44px"></i>
                  <div class="dd-content">
                    <H2 class="dd-main">Products</H2>
                    <H3 class="dd-sub">Add Atleast One Product!</H3> 
                  </div>
                </a>
            </div>
...
<div class="col-md-4">
    <ul class="dd-header">
        <li>
            <div>
                <a href ="#">
                  <i class="icon-beaker"><img src="{{config('global.THEME_URL_IMAGE').'/images/'.$verifyDetailsImg}}" style="width: 44px"></i>
                  <div class="dd-content">
                    <H2 class="dd-main">Verify Details</H2>
                    <H3 class="dd-sub">Verify Your Email & Mobile Number</H3> 
                  </div>
                </a>
            </div>
    ...
    <ul class="dd-header">
        <li>
            <div>
                <a href ="{{env('SITE_URL').'/seller/'.$sellerArr->pincode.'/'.$sellerArr->businessusername}}">
                  <i class="icon-bar-chart"><img src="{{config('global.THEME_URL_IMAGE').'/images/'.$liveImg}}" style="width: 44px"></i>
                  <div class="dd-content">
                    <H2 class="dd-main">Shop Published</H2>
                    <H3 class="dd-sub">This will show your shop is published or not!</H3> 
                  </div>
                </a>
            </div>
