<div class="tab-content">
                    ...
                    @if(!empty($userProduct['default_thumbnail']))
                     <div class="form-group">
                        <label for="inputPassword" class="col-sm-2 control-label">@lang('product.image')</label>
                        <div class="col-sm-2">
                            <img src="{{config('global.PRODUCTS_NEW_STORAGE_DIR').DIRECTORY_SEPARATOR.$sellerId.DIRECTORY_SEPARATOR.config('global.PRODUCT_THUMB_IMG_WIDTH').'X'.config('global.PRODUCT_THUMB_IMG_HEIGHT').DIRECTORY_SEPARATOR.$userProduct['default_thumbnail']}}" />
                        </div>
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <a href="{{route('allproduct')}}" class="btn btn-danger" style="margin-left:38px">Cancel</a>
