...
<body id="product" class="lang-en country-us currency-usd layout-right-column page-product tax-display-disabled product-id-1 product-curabitur-dolor-nunc-consectetur-adipiscing product-id-category-3 product-id-manufacturer-1 product-id-supplier-0 product-on-sale product-available-for-order" style="">
<main>
<!-- BEGIN MAIN CONTENT -->
@yield('content')
<!-- END MAIN CONTENT -->
