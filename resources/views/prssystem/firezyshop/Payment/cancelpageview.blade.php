...
<div class="jumbotron text-center">
  <h1 class="display-3">Opps your order in not confirmed !</h1>
  ...
  <form id="choosePay" action="{{route('choosepayment')}}" method="get">
    ...
    <input type="hidden" name="shippingAddress" id="shippingAddress" value="{{$shipping_id}}">
    {{csrf_field()}}
    <button class="btn btn-primary btn-sm">Retry For Payment</button>
  </form>
