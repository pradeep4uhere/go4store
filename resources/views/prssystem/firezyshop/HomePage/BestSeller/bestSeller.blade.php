<div class="container">
	...
	<div class="side-banner">
			...
			<a class="all-product-link pull-xs-left pull-md-right h4" href="?controller=best-sales">
			view more
			</a>
			</div>
	...
	<div class="products">		
		<ul id="tmcategory3-carousel" class="tm-carousel product_list product_slider_grid owl-carousel owl-theme" data-catid="3" style="opacity: 1; display: block;">
			<div class="owl-carousel owl-theme" id="owl-demo-best-seller">
			<?php if(!empty($sellerArr)){ ?>
			<?php foreach($sellerArr as $sellerItem){ ?>
			@include('prssystem.firezyshop.HomePage.BestSeller.sellerItem',array('sellerItem'=>$sellerItem))
			<?php } ?>
			<?php } ?>
